...
let birinciDeger = 10; let ikinciDeger = 15;
...
function cocukSarkisi(i) {
  ...
  return(i + 1 + " küçük maymun yatakta zıplamış, biri düşüp başını çarpmış, Anne doktoru aramış, Doktor çok kızmış: Bir daha yatakta zıplamak yok!")
}
